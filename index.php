...
<head>
    ...
    <title>OSMW <?php echo INI_Conf('VersionOSMW', 'VersionOSMW'); ?></title>
...
<div class="container">
    ...
    if (isset($_POST['firstname']) && isset($_POST['lastname']) && isset($_POST['pass']))
    {
        ...
        if ($auth == false)
        {
            echo '<div class="alert alert-danger alert-anim">Vous ne pouvez pas accéder à cette page</div>';
    ...
    if (isset($_SESSION['authentification']))
    {
        ...
        if (isset($_GET['a']) && !empty($_GET['a']))
        {
            ...
            if ($a == "24") {include('inc/GestTos.php');}               // # Gestion des Conditions d'utilisation)
        }
    ...
    <form class="form-signin" action="index.php" method="post" name="connect">
        ...
        <a href="./"><img style="height:128px;" class="img-thumbnail img-circle center-block" alt="Logo Server" src="img/logo.png"></a><br />
    ...
    <footer class="footer">
        <p class="text-center">
            OpenSimulator Manager Web v<?php echo INI_Conf('VersionOSMW', 'VersionOSMW'); ?> 
            by djphil <a href="https://creativecommons.org/licenses/by-nc-sa/4.0/legalcode.fr" class="label label-primary">CC-BY-NC-SA 4.0</a>
        </p>
    </footer>
</div>
