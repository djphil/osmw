...
if (isset($_SESSION['authentification']) && $_SESSION['privilege'] >= 3)
{
    ...
    if (isset($_POST['cmd']))
    {
        if ($_POST['cmd'] == 'Ajouter')
        {
            ...
            echo '</tr>';
            echo '<tr>';
            echo '<td><input class="form-control" type="text" name = "NewName" value="MySimulator'.$i.'" '.$btnN3.'"></td>';
            echo '<td><input class="form-control" type="text" name = "version" value="0.9.1.1" '.$btnN3.'"></td>';
            echo '<td><input class="form-control" type="text" name = "address" value="D:/opensim/MySimulator'.$i.'/bin/" '.$btnN3.'></td>';
            echo '<td><input class="form-control" type="text" name = "hypergrid" value="hg.mysimulator'.$i.'.com:8002" '.$btnN3.'></td>';
            echo '<td><input class="form-control" type="text" name = "DB_OS" value="MySimulator'.$i.' database" '.$btnN3.'></td>';
