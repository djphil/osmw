...
if (isset($_SESSION['authentification']))
{
    ...
    echo '<button type="submit" class="btn btn-danger" name="cmd" '.$btnN3.'>';
    echo '<i class="glyphicon glyphicon-trash"></i> Effacer le fichier Log</button>';
    echo '</form>';
    ...
    if ($fichierLog <> "")
    {
        ...
        if (!$aff)
        {
            if (!$logfile) $aff = "Le fichier Log est vide ...";
